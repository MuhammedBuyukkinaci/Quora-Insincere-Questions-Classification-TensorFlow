...
LSTM_CELL = tf.contrib.cudnn_rnn.CudnnLSTM(num_layers=1,num_units=GRU_UNITS,                                         bias_initializer = tf.constant_initializer(0.1),                                         kernel_initializer=tf.contrib.layers.xavier_initializer() )
